...
public class Adapter_Test extends RecyclerView.Adapter<Adapter_Test.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.txt_count_photo.setText(tempArr.get(position).getViewimage()+"");
        holder.txt_count_like.setText(tempArr.get(position).getLikeimage()+"");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            txt_count_like=(TextView)itemView.findViewById(R.id.txt_count_like);
