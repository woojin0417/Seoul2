        ...
        call.enqueue(new Callback<FrameVO>() {
            ...
            public void onResponse(Call<FrameVO> call, Response<FrameVO> response) {
                ...
                for(int i=0; i< innerVOs.size(); i++) {
                    ...
                    BaseActivity.testArr.add(new Model_Test(number, area, initials, name, lat, lng, subway, bus, bicycle, url, smartPhone, filter, theme1, theme2, time, tip, likeimage, viewimage));
                    Log.v("res", area);
